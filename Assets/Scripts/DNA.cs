...
public class DNA
{
	...
	private Func<Vector2> getRandomGene;// Random gene
	public Func<float> fitnessFunction;// Function of the fitness
	public Vector2[] directions;
	public int step = 0;

	public DNA(int size, System.Random random, Func<Vector2> getRandomGene, Func<float> fitnessFunction, bool shouldInitGenes = true)
	{
